...
describe('ModeScreen', () => {
  ...
  it('should render with proper styling classes', () => {
    ...
    const listenButton = screen.getByText('Listen')
    expect(listenButton).toHaveClass('btn-game', 'btn-mode', 'px-6', 'py-8', 'rounded-2xl', 'text-2xl', 'font-bold', 'hover:scale-105')

    const readButton = screen.getByText('Read')
    expect(readButton).toHaveClass('btn-game', 'btn-mode', 'px-6', 'py-8', 'rounded-2xl', 'text-2xl', 'font-bold', 'hover:scale-105')

    const writeButton = screen.getByText('Write')
    expect(writeButton).toHaveClass('btn-game', 'btn-mode', 'px-6', 'py-8', 'rounded-2xl', 'text-2xl', 'font-bold', 'hover:scale-105')
  ...
  it('should render with responsive grid layout', () => {
    ...
    expect(gridContainer).toHaveClass('grid', 'grid-cols-1', 'md:grid-cols-3', 'gap-6', 'w-full', 'max-w-2xl', 'mb-8')
  })
  ...
  it('should render emoji icons correctly', () => {
    ...
    expect(listenEmoji).toHaveClass('text-4xl', 'mb-2')

    const readEmoji = screen.getByText('📖')
    expect(readEmoji).toHaveClass('text-4xl', 'mb-2')

    const writeEmoji = screen.getByText('✍️')
    expect(writeEmoji).toHaveClass('text-4xl', 'mb-2')
  })
